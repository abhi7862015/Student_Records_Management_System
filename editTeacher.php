...
if (mysqli_num_rows($result2) > 0) {
    ...
    $Gender = $rows2['gender'];
    $Status = $rows2['status'];
    $AttendedClass = $rows2['attended_class'];
    $SubjectExpertise = $rows2['subject_expertise'];
    $Experience = $rows2['experience'];
} else {
...
if (isset($_POST['submit']) && $_POST['submit'] == 'Submit') {
    ...
    $query1 = "UPDATE teacher_details SET first_name='$first_name', last_name='$last_name', email='$email', gender='$Gender', status='$Status', attended_class='$AttendedClass', subject_expertise='$SubjectExpertise', experience='$Experience', last_updated_date=CURRENT_TIMESTAMP WHERE id='$teacher_id'";
    if ($conn->query($query1)) {
        // Set success message for updating existing record
        $teacher_success = "Data Updated Successfully!";
    }
}
