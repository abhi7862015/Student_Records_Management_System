                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="FirstName" name="FirstName" <?php if($user_type == "Teacher" || $user_type == "Student") echo "disabled";?>  value='<?php if (isset($first_name))
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="LastName" name="LastName" <?php if($user_type == "Teacher" || $user_type == "Student") echo "disabled";?>  value='<?php if (isset($last_name))
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="Email" name="Email" <?php if($user_type == "Teacher" || $user_type == "Student") echo "disabled";?>  value='<?php if (isset($email))
